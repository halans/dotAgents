...
**Note**: Set this environment variable for convenience:
```bash
# Add to ~/.zshrc or ~/.bashrc
export SKILL_PATH="/path/to/dotAgents/skills/query-confluence"
# OR if using skilz installer:
export SKILL_PATH="~/.claude/skills/confluence"
```
...
1. Verify skill is in `$SKILL_PATH/`
...
2. Check script permissions: `ls -l $SKILL_PATH/scripts/`
3. Run directly: `python3 $SKILL_PATH/scripts/convert_markdown_to_wiki.py`
