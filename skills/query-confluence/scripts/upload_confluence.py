#!/usr/bin/env python3
"""
Upload Markdown to Confluence (DEPRECATED - USE upload_confluence_v2.py)

⚠️  DEPRECATION WARNING  ⚠️
This script (v1) is deprecated and has known issues:
- Uses MermaidConfluenceRenderer which breaks regular image handling
- Less reliable error handling
- Missing features from v2

PLEASE USE: upload_confluence_v2.py instead!
...
# Print deprecation warning when script loads
print("=" * 70, file=sys.stderr)
print("⚠️  DEPRECATION WARNING", file=sys.stderr)
print("=" * 70, file=sys.stderr)
print("This script (upload_confluence.py) is DEPRECATED.", file=sys.stderr)
print("Please use: upload_confluence_v2.py", file=sys.stderr)
print("", file=sys.stderr)
print("v2 fixes critical issues with image handling and error reporting.", file=sys.stderr)
print("=" * 70, file=sys.stderr)
print("", file=sys.stderr)
