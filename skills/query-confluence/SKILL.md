...
For convenience, set an environment variable pointing to this skill directory:

```bash
# Add to ~/.zshrc or ~/.bashrc
export SKILL_PATH="/path/to/dotAgents/skills/query-confluence"
```

Or use the absolute path to your skill installation. The examples below use `$SKILL_PATH` - replace with your actual path:
- dotAgents: `~/Development/GitHub/dotAgents/skills/query-confluence`
- skilz install: `~/.claude/skills/confluence` (if using skilz installer)
- Custom: Your installation directory
...
python3 $SKILL_PATH/scripts/upload_confluence_v2.py \
...
```bash
# Single page
python3 $SKILL_PATH/scripts/download_confluence.py 123456789

# With child pages
python3 $SKILL_PATH/scripts/download_confluence.py --download-children 123456789

# Custom output directory
python3 $SKILL_PATH/scripts/download_confluence.py --output-dir ./docs 123456789
```
