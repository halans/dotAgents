...
- **Main documentation**: `$SKILL_PATH/SKILL.md`
- **Wiki Markup guide**: `$SKILL_PATH/references/wiki_markup_guide.md`
- **Conversion guide**: `$SKILL_PATH/references/conversion_guide.md`
- **mark tool guide**: `$SKILL_PATH/references/mark_tool_guide.md`
- **Scripts**: `$SKILL_PATH/scripts/`
- **Examples**: `$SKILL_PATH/examples/`
